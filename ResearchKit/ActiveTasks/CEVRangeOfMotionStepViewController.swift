//
//  CEVRangeOfMotionStepViewController.swift
//  ResearchKit
//
...
public class CEVRangeOfMotionStepViewController: ORKRangeOfMotionStepViewController {
    ...
    public override var result: ORKStepResult? {
        ...
        guard let step = step as? CEVRangeOfMotionStep else {
            return nil
        }
    
        let result = ORKRangeOfMotionResult(identifier: step.identifier)
...
extension CEVRangeOfMotionStepViewController {
    ...
    func directionOfRotation(rawAngle: Double, lastRawAngle: Double) -> CEVDirectionOfRotation {
        if crossesAxis(rawAngle: rawAngle, lastRawAngle: lastRawAngle) {
